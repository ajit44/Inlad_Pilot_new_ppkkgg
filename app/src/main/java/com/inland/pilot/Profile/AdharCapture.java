...
import com.inland.pilot.LoadImage.LoadImageCapture;
...
public class AdharCapture extends AppCompatActivity {
    ...
    private ActivityAdharCaptureBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_adhar_capture);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_adhar_capture);
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int permission = ActivityCompat.checkSelfPermission(AdharCapture.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                ...
                if (AdharCapture.this.getPackageManager().hasSystemFeature(
                        PackageManager.FEATURE_CAMERA))
                {
                    if (ActivityCompat.checkSelfPermission(AdharCapture.this, Manifest.permission.CAMERA)
                            != PackageManager.PERMISSION_GRANTED) {
                        // Check Permissions Now
                        // Callback onRequestPermissionsResult interceptado na Activity MainActivity
                        ActivityCompat.requestPermissions(AdharCapture.this,
                    ...
                    Toast.makeText(AdharCapture.this, "Camera not supported", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void uploadImageOld(File file) {
        ...
        call.enqueue(new Callback<Response<String>>() {
            ...
            public void onResponse(Call<Response<String>> call, Response<Response<String>> response) {
                ...
                {
                    dialog.dismiss();
                    Dialog notFoundDialog = new Dialog(AdharCapture.this);
                    ...
                    Icon.setImageDrawable(AdharCapture.this.getResources().getDrawable(R.drawable.done));
                    ...
                    backBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(AdharCapture.this);
                            SharedPreferences.Editor editor = preferences.edit();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 100 && resultCode == RESULT_OK) {
            ...
            try {
                ...
                CropImage.activity(mImageUri).start(AdharCapture.this);
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {    try{
          ...
          /*  if(size>700000) {
                ...
                Bitmap finalBit = ImageResizer.reduceBitmapSize(bitmap, 600000);
                binding.imageView.setImageBitmap(finalBit);
    ...
    private String getFilename() {
        ...
        file_name=mobile_no+"_Adhar_image";
        try {
            if (!file.exists()) {
                file.mkdirs();
            }
