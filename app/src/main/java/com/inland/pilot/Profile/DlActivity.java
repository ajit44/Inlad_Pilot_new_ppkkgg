...
import com.inland.pilot.databinding.ActivityDlBinding;
...
public class DlActivity extends AppCompatActivity {
    ...
    private ActivityDlBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_dl);
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int permission = ActivityCompat.checkSelfPermission(DlActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                ...
                if (DlActivity.this.getPackageManager().hasSystemFeature(
                        PackageManager.FEATURE_CAMERA))
                {
                    if (ActivityCompat.checkSelfPermission(DlActivity.this, Manifest.permission.CAMERA)
                            != PackageManager.PERMISSION_GRANTED) {
                        // Check Permissions Now
                        // Callback onRequestPermissionsResult interceptado na Activity MainActivity
                        ActivityCompat.requestPermissions(DlActivity.this,
                    ...
                    Toast.makeText(DlActivity.this, "Camera not supported", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void uploadImageOld(File file) {
        ...
        call.enqueue(new Callback<Response<String>>() {
            ...
            public void onResponse(Call<Response<String>> call, Response<Response<String>> response) {
                ...
                {
                    dialog.dismiss();
                    Dialog notFoundDialog = new Dialog(DlActivity.this);
                    ...
                    Icon.setImageDrawable(DlActivity.this.getResources().getDrawable(R.drawable.done));
                    ...
                    backBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(DlActivity.this);
                            SharedPreferences.Editor editor = preferences.edit();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 100 && resultCode == RESULT_OK) {
            ...
            try {
                ...
                CropImage.activity(mImageUri).start(DlActivity.this);
    ...
    private String getFilename() {
        ...
        file_name=mobile_no+"_Driv_image";
        try {
            if (!file.exists()) {
                file.mkdirs();
            }
