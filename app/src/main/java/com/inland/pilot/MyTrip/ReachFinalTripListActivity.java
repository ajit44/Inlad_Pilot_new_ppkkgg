...
public class ReachFinalTripListActivity extends AppCompatActivity {
    private ActivityOnGoingTripBinding binding;
    private Context mCon;
    private TripReachedFinalListAdapter tripListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCon = this;
        tripListAdapter = new TripReachedFinalListAdapter(mCon);
        ...
        if (PreferenceUtil.getUser() != null) {
            if (PreferenceUtil.getUser().getP_MOBILENO() != null && !PreferenceUtil.getUser().getP_MOBILENO().isEmpty()) {
                ...
                tripListModel = new RequestTripListModel("1",loginIdStr);
